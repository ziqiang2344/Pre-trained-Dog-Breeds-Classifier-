    ...
    for idx in range(0, len(in_files), 1):
       ...
       # TODO: 2a. BELOW REPLACE pass with CODE that will process each 
        ...
        if in_files[idx] not in results_dic:
            ...
            # Turn the filename to lower string and remove "_" from the
            processed_filename_1 = in_files[idx].lower().split("_")
                    
            # Remove the numbers 
            for word in processed_filename_1:
                if word.isalpha():
                    pet_label += word + " "
